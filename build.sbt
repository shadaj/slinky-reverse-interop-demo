...
npmDevDependencies in Compile += "babel-loader" -> "7.1.4"
npmDevDependencies in Compile += "babel-core" -> "6.26.3"
npmDevDependencies in Compile += "@babel/preset-env" -> "7.0.0-beta.51"
npmDevDependencies in Compile += "babel-preset-react" -> "6.24.1"
